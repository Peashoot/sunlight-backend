...
type GroupMembershipModel struct {
	BaseModel
	MemberCode string `gorm:"size:50;comment:成员编号;uniqueIndex:unique_index_group_member"` // 成员编号
	GroupCode  string `gorm:"size:50;comment:组编号;uniqueIndex:unique_index_group_member"`  // 组编号
